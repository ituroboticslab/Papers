...
%-------------
   ...
   \begin{center}
   \begin{tabular}{c}
   \includegraphics[height=5.5cm]{figures/mcr3b.eps}
   \end{tabular}
   \end{center}
   \caption 
...
%------------- 
   ...
   \begin{center}
   \begin{tabular}{c}
   \includegraphics[height=5.5cm]{figures/fig2.eps}  % fig2 includes two images 
     \\
     (a) \hspace{5.1cm} (b)
   \end{tabular}
   \end{center}
...
%-------------
   \begin{video}
   \begin{center}
   {\includegraphics[height=5cm]{figures/satellite.eps}}
   \\
   \end{center}
