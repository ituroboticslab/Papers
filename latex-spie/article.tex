...
%VANGELden
%the performance shown in Table/figure is  representative as the results are obtained with a %manually annotated É.
%our demo video provides qualitative loop closure results which may be considered to be more representative for our methodÕs performance
...
\begin{figure}[!htb]
        ...
        \hspace{-3mm}
        \caption{Similarity matrices of the captured images in experimental results. Condensed fray shades point out to positive alikeness between scenes. The black lines in lower triangle indicates user specified ground truths. The gray lines in upper-triangle shows the obtained results.}
